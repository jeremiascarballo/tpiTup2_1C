...
const FindMovie = () => {
  ...
  <div className="grid grid-cols-4 min-h-screen bg-black">
    ...
    <div className="col-span-1 text-white text-left p-10">
      <h1 className="text-5xl mb-6">Título: {movie.title}</h1>
      <h2 className="text-xl mb-4">Duración: {movie.duration}</h2>
      <h2 className="text-xl mb-4">Director: {movie.director}</h2>
      <h2 className="text-xl mb-4">Calificación: {movie.qualification}</h2>
